...
public class EditMahasiswa extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getMahasiswa(){
        class GetMahasiswa extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(EditMahasiswa.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void updateMahasiswa(){
        ...
        class UpdateMahasiswa extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(EditMahasiswa.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(EditMahasiswa.this,s, Toast.LENGTH_LONG).show();
            }
    ...
    private void deleteMahasiswa(){
        class DeleteMahasiswa extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(EditMahasiswa.this, "Updating...", "Tunggu...", false, false);
            }
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteMahasiswa();
                        startActivity(new Intent(EditMahasiswa.this, ListMahasiswa.class));
                    }
                });
